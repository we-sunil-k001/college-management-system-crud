                    ...
                    <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="pt-4 pb-2">
                                    <h5 class="card-title text-center pb-0 mb-3 fs-4">Forget Password</h5>
                                    <!--                    <p class="text-center small">Enter your username & password to login</p>-->
                                </div>

                                <form class="row g-3 needs-validation" novalidate method="post"
                                      action="includes/function.php">
                                    ...
                                    <div class="col-12 mt-4">
                                        <button class="btn btn-primary w-100" name="forget_password" type="submit">Submit</button>
                                    </div>
